...
class role::phabricator::sprint {
   ...
   exec { 'storage_update':
    ...
    augeas { "50-phabricator.conf":
       ...
       changes => [
       "set /files/etc/apache2/sites-available/50-phabricator.conf/VirtualHost/directive SetEnv",
       "set /files/etc/apache2/sites-available/50-phabricator.conf/VirtualHost/*[self::directive='SetEnv']/arg[1] PHABRICATOR_ENV",
       "set /files/etc/apache2/sites-available/50-phabricator.conf/VirtualHost/*[self::directive='SetEnv']/arg[2] default",
       ],
    }
}
